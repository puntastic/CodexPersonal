...
#[test_case::test_case(true, false; "host-required")]
#[test_case::test_case(false, true; "fresh-required")]
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn required_guardian_without_cancellation_overrides_extension_ask_user(
    ...
    let context = ApprovalContext {
        ...
        strict_auto_review,
        approval_reason: None,
        retry_reason: require_fresh_review.then(|| "fresh review required".to_string()),
        network_approval_context: None,
    };
