...
impl GuardianReviewSessionReuseKey {
    fn from_spawn_config(
        ...
        let tracks_review_history =
            ReviewContextPolicy::for_context(context_mode, &spawn_config.features)
                != ReviewContextPolicy::Legacy;
        Self {
            ...
            review_history_version: if tracks_review_history {
